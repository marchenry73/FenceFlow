    ...
    private suspend fun pullJobChildren(repository: Repository, companyId: String): Int {
        ...
        usable.forEach { row ->
            ...
            if (existing == null) {
                ...
                // already corrected.
                //
                // supplierUnitPrice is deliberately NOT touched: the cloud shape
                // does not carry it, so naming it here would blank out the
                // supplier pricing on every sync. Keeping it local is wrong too,
                // but wrong quietly rather than destructively -- see the note in
                // the commit.
                //
